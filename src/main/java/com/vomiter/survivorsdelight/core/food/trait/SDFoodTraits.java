...
public final class SDFoodTraits {
    ...
    public static final FoodTrait FOOD_MODEL =
            FoodTrait.register(FOOD_MODEL_ID, new FoodTrait(0.0f, KEY_PREFIX + "food_model"));
    public static final FoodTrait SKILLET_COOKED =
            FoodTrait.register(SKILLET_COOKED_ID, new FoodTrait(0.8f, KEY_PREFIX + "skillet_cooked"));
